...
@section('content')
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Appointment
                        ...
                        <!--end::Separator-->
                        <!--begin::Description-->
                        <small class="text-muted fs-7 fw-bold my-1 ms-1">Cancelled Appointment</small>
                        <!--end::Description-->
                    </h1>
                    <!--end::Title-->
                </div>
                        ...
                        <div class="card card-xl-stretch mb-5 mb-xl-8">
                            ...
                            <div class="card-header border-0 pt-5">
                                <h3 class="card-title align-items-start flex-column">
                                    <span class="card-label fw-bolder fs-3 mb-1">Cancelled Appointment</span>
                                </h3>
    ...
    <script>
        function fetch_data(query = '', page = 1) {
            $.ajax({
                url: "{{ route('admin.searchcancelapptdoc') }}",
                method: 'GET',
                data: {
                    query: query,
                    page: page
