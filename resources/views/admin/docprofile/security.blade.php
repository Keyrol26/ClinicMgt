            ...
            <div id="kt_content_container" class="container-xxl">
                ...
                <div class="card mb-5 mb-xl-10">
                    ...
                    <div id="kt_account_profile_details" class="collapse show">
                        ...
                        <form method="post" name="submit" id="kt_account_profile_details_form" class="form"
                            action="{{ route('admindocpass.update', $profile->user->id) }}">
                            @csrf
                            @method('put')
                            <!--begin::Card body-->
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="position-relative mb-3">
                                                <input class="form-control form-control-lg form-control-solid"
                                                    type="password" placeholder="" id="passvisible" name="password"
                                                    autocomplete="off" />
                                                <span
                ...
                <div class="card mb-5 mb-xl-10">
                    ...
                    <div id="kt_account_profile_details" class="collapse show">
                        <!--begin::Form-->
                        <form method="post" name="submit" id="kt_account_profile_details_form" class="form"
                            action="{{ route('admindocemail.update', $profile->user->id) }}">
                            @csrf
                            @method('put')
                            <!--begin::Card body-->
                            <div class="card-body border-top p-9">
                ...
                <div class="card mb-5 mb-xl-10">
                    ...
                    <div class="card-header border-0">
                        <!--begin::Card title-->
                        <div class="card-title m-0">
                            <h3 class="fw-bolder m-0">Delete Patient</h3>
                        </div>
                        <!--begin::Actions-->
                        ...
                        <div class="modal fade" id="deletemodal" data-backdrop="static" tabindex="-1" role="dialog"
                            ...
                            <form action="{{ route('doctordelete.delete', $profile->user->id) }}" method="post">
                                @csrf
                                @method('DELETE')
