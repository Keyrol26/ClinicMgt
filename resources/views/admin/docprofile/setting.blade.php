                        ...
                        <div class="d-flex flex-wrap flex-sm-nowrap mb-3">
                            ...
                            <div class="me-7 mb-4">
                                <div class="symbol symbol-100px symbol-lg-160px symbol-fixed position-relative">
                                    @if ($profile->user->role == 'doctor' && $profile->gender == 'm')
                                        <img src="{{ asset('metronic/assets/media/avatars/doctor.svg') }}" alt="user" />
                                    @elseif($profile->user->role == 'doctor' && $profile->gender == 'f')
                                        <img src="{{ asset('metronic/assets/media/avatars/fdoctor.svg') }}"
                                            alt="user" />
                                    @elseif($profile->user->role == 'doctor' && $profile->gender == '')
                                        ...
                                        <div class="d-flex flex-wrap fw-bold fs-6 mb-4 pe-2">
                                            <a class="d-flex align-items-center text-gray-400  me-5 mb-2">
                                                ...
                                                @if ($profile->user->role == 'user')
                                                    <!--end::Svg Icon-->Patient
                                            </a>
                                        @else
                                            <!--end::Svg Icon-->{{ $profile->user->role }}</a>
                                            @endif
                                            ...
                                            <a class="d-flex align-items-center text-gray-400 mb-2">
                                                ...
                                                <!--end::Svg Icon-->{{ $profile->user->email }}</a>
                                        </div>
                                        <!--end::Info-->
                                        <a
                                            class="text-gray-500 fs-2 fw-bolder me-1 ">{{ $profile->specialization->specialization ?? '' }}</a>
                                        <a
                                            class="d-flex align-items-center text-gray-400 mb-2">{{ $profile->qualification ?? '' }}</a>
                                    </div>
                                    <!--end::User-->
                                </div>
                                <!--end::Title-->
                        ...
                        <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bolder">
                            ...
                            <li class="nav-item mt-2">
                                <a class="nav-link text-active-primary ms-0 me-10 py-5"
                                    href="{{ route('admindocprofile', [$profile->id]) }}">Overview</a>
                            </li>
                            <!--end::Nav item-->
                            ...
                            <li class="nav-item mt-2">
                                <a class="nav-link text-active-primary ms-0 me-10 py-5 active"
                                    href="{{ route('admindocsetting', [$profile->id]) }}">Settings</a>
                            </li>
                            <!--end::Nav item-->
                            <!--begin::Nav item-->
                            <li class="nav-item mt-2">
                                <a class="nav-link text-active-primary ms-0 me-10 py-5"
                                    href="{{ route('admindocpass', [$profile->id]) }}">Security</a>
                            </li>
                            <!--end::Nav item-->
                        </ul>
                        <!--begin::Navs-->
                ...
                <div class="card mb-5 mb-xl-10">
                    ...
                    <div id="kt_account_profile_details" class="collapse show">
                        ...
                        <form method="post" name="submit" id="kt_account_profile_details_form" class="form"
                            action="{{ route('admindocprofile.update', $profile->user->id) }}">
                            @csrf
                            @method('put')
                            <!--begin::Card body-->
                            <div class="card-body border-top p-9">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12 fv-row">
                                                <input type="text" name="Name"
                                                    ...
                                                    placeholder="Full name" value="{{ $profile->user->name }}" />
                                                @error('Name')
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8 fv-row">
                                        <select name="specialization" aria-label="Select a Specialization"
                                            data-control="select2" data-placeholder="Select a gender..."
                                            class="form-select form-select-solid form-select-lg fw-bold">
                                            <option value="">Select a Specialization...</option>
                                            @foreach ($Specializations as $specialization)
                                                <option value="{{ $specialization->id }}"
                                                    @if ($profile->specialization_id == $specialization->id) selected @endif>
                                ...
                                <div class="row mb-6">
                                    <!--begin::Label-->
                                    <label class="col-lg-4 col-form-label fw-bold fs-6">Qualification</label>
                                    <!--end::Label-->
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row">
                                        <textarea type="text" name="qualification" class="form-control form-control-lg form-control-solid"
                                            placeholder="Qualification">{{ $profile->qualification }}</textarea>
                                    </div>
                                    <!--end::Col-->
                                </div>
                                <!--end::Input group-->
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8 fv-row">
                                        <input type="tel" name="phoneno"
                                            ...
                                            placeholder="Phone number" value="{{ $profile->phoneno }}" />
                                        @error('phoneno')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8 fv-row">
                                        <input type="date" name="dob"
                                            ...
                                            value="{{ \Carbon\Carbon::parse($profile->dob)->format('Y-m-d') }}" />
                                        @error('dob')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="row mb-6">
                                    <!--begin::Label-->
                                    <label class="col-lg-4 col-form-label required fw-bold fs-6">Joined Date</label>
                                    <!--end::Label-->
                                    <div class="col-lg-8 fv-row">
                                        <input type="tel" name="created_at"
                                            class="form-control form-control-lg form-control-solid"
                                            placeholder="created_at"
                                            value="{{ Carbon::parse($profile->created_at)->format('d-m-Y') }}" disabled
                                            style="color: gray;" />
                                    </div>
                                </div>
                                <!--end::Input group-->
