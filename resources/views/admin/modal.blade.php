        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <table class="table table-bordered table-hover data-tables">
                    ...
                    <form method="post" name="submit" action="{{ route('adminappointment.update', $appointment->id) }}">
                        @csrf
                        @method('put')
                        <tr class="fw-bolder ">
                            <th>Remark :</th>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <table class="table table-bordered table-hover data-tables">
                    ...
                    <form method="post" name="submit" action="{{ route('adminappointmentreport.update', $appointment->id) }}">
                        @csrf
                        @method('put')
                        <tr class="fw-bolder ">
