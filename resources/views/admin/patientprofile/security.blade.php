            ...
            <div id="kt_content_container" class="container-xxl">
                ...
                <div class="card mb-5 mb-xl-10">
                    ...
                    <div id="kt_account_profile_details" class="collapse show">
                        ...
                        <form method="post" name="submit" id="kt_account_profile_details_form" class="form"
                            action="{{ route('patientpassupdate.update', $profile->user->id) }}">
                            @csrf
                            @method('put')
                            <!--begin::Card body-->
                ...
                <div class="card mb-5 mb-xl-10">
                    ...
                    <div id="kt_account_profile_details" class="collapse show">
                        <!--begin::Form-->
                        <form method="post" name="submit" id="kt_account_profile_details_form" class="form"
                            action="{{ route('patientemailupdate.update', $profile->user->id) }}">
                            @csrf
                            @method('put')
                            <!--begin::Card body-->
                            <div class="card-body border-top p-9">
                ...
                <div class="card mb-5 mb-xl-10">
                    ...
                    <div class="card-header border-0">
                        ...
                        <div class="modal fade" id="deletemodal" data-backdrop="static" tabindex="-1" role="dialog"
                            ...
                            <form action="{{ route('patientdelete.delete', $profile->user->id) }}" method="post">
                                @csrf
                                @method('DELETE')
