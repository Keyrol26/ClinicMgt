            ...
            <div id="kt_content_container" class="container-xxl">
                ...
                <div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
                    ...
                    <div class="card-header border-0">
                        ...
                        <!--end::Card title-->
                        <!--begin::Action-->
                        <a href="{{ route('adminsetting') }}" class="btn btn-primary align-self-center">Edit
                            Profile</a>
                        <!--end::Action-->
                    </div>
                    <!--begin::Card header-->
                    ...
                    <div class="card-body p-9">
                        ...
                        <div class="row mb-7">
                            ...
                            <div class="col-lg-8">
                                <span
                                    class="fw-bolder fs-6 text-gray-800">{{ Carbon::parse(Auth::user()->admin->created_at)->format('d F, Y') }}</span>
                            </div>
                            <!--end::Col-->
                        </div>
                        <!--end::Input group-->
