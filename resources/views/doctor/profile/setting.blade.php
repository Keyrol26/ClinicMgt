                                ...
                                <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                                    ...
                                    <div class="d-flex flex-column ">
                                        ...
                                        <div class="d-flex align-items-center mb-5">
                                            <a class="text-gray-900 fs-2 fw-bolder me-1">{{ Auth::user()->name }}</a>
                                            <a>
                ...
                <div class="card mb-5 mb-xl-10">
                    ...
                    <div id="kt_account_profile_details" class="collapse show">
                        ...
                        <form method="post" name="submit" id="kt_account_profile_details_form" class="form"
                            action="{{ route('docprofile.update', Auth::user()->id) }}">
                            @csrf
                            @method('put')
                            <!--begin::Card body-->
                                        ...
                                        <select name="specialization" aria-label="Select a Specialization"
                                            ...
                                            @foreach ($Specializations as $specialization)
                                                <option value="{{ $specialization->id }}"
                                                    @if (Auth::user()->doctor->specialization_id == $specialization->id) selected @endif>
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8 fv-row">
                                        <textarea type="text" name="qualification" class="form-control form-control-lg form-control-solid"
                                            placeholder="Qualification">{{ Auth::user()->doctor->qualification }}</textarea>
                                    </div>
                                    <!--end::Col-->
                                </div>
                                <!--end::Input group-->
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8 fv-row">
                                        <input type="tel" name="phoneno"
                                            ...
                                            placeholder="Phone number" value="{{ Auth::user()->doctor->phoneno }}" />
                                    </div>
                                    <!--end::Col-->
                                </div>
                                <!--end::Input group-->
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8 fv-row">
                                        <textarea type="text" name="address" class="form-control form-control-lg form-control-solid"
                                            placeholder="Address">{{ Auth::user()->doctor->address }}</textarea>
                                    </div>
                                    <!--end::Col-->
                                </div>
                                <!--end::Input group-->
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8 fv-row">
                                        <select name="gender" aria-label="Select a Gender" data-control="select2"
                                            ...
                                            <option value="m"
                                                {{ Auth::user()->doctor->gender == 'm' ? 'selected' : '' }}>
                                                Male
                                            </option>
                                            <option value="f"
                                                {{ Auth::user()->doctor->gender == 'f' ? 'selected' : '' }}>
                                                Female</option>
                                        </select>
                                    </div>
                                    <!--end::Col-->
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8 fv-row">
                                        <input type="date" name="dob"
                                            ...
                                            value="{{ \Carbon\Carbon::parse(Auth::user()->doctor->dob)->format('Y-m-d') }}" />
                                    </div>
                                </div>
                                <!--end::Input group-->
                                <!--begin::Input group-->
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8 fv-row">
                                        <input type="tel" name="created_at"
                                            ...
                                            value="{{ Carbon::parse(Auth::user()->created_at)->format('d-m-Y') }}"
